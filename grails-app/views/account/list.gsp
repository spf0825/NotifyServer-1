			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="account.phone.label" default="Phone" /></th>
				...
				<g:each in="${accountInstanceList}" status="i" var="accountInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${accountInstance.id}">${fieldValue(bean: accountInstance, field: "number")}</g:link></td>

						<td>${fieldValue(bean: accountInstance, field: "bank")}</td>
